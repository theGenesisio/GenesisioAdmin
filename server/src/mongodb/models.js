...
import { refreshTokenSchema, adminSchema, billingSchema, userSchema, KYCSchema, depositSchema, withdrawalRequestSchema, whatsappSchema, notificationSchema, plansSchema, investmentSchema, topupSchema, livetradeSchema, MailLogSchema, copytradeSchema, traderSchema, livePriceSchema, tierSchema, upgradeSchema } from './schema.js';
...
const models = [RefreshToken, User, KYC, Billing, Deposit, WithdrawalRequest, AdminRefreshToken, Admin, Billing, Whatsapp, Notification, Plan, Investment, Topup, LiveTrade, Mail, Trader, CopyTrade, LivePrice, Tier, Upgrade]
import './methods/schemaHelpers.js'
export { models, AdminRefreshToken, Admin, Billing, RefreshToken, User, KYC, Deposit, WithdrawalRequest, Whatsapp, Notification, Plan, Investment, Topup, LiveTrade, Mail, Trader, CopyTrade, LivePrice, Tier, Upgrade };